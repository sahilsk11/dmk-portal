...
class ContentContainer extends react__WEBPACK_IMPORTED_MODULE_3___default.a.Component {
  ...
  componentDidMount() {
    if (js_cookie__WEBPACK_IMPORTED_MODULE_4___default.a.get("token") == undefined) {
      ...
      this.setState({
        username: js_cookie__WEBPACK_IMPORTED_MODULE_4___default.a.get("token")
      });
    }
  ...
  fetchPageData() {
    const url = "http://localhost:8080/pageData?username=" + js_cookie__WEBPACK_IMPORTED_MODULE_4___default.a.get("token");
