...
function (_React$Component6) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_4__["default"])(CheckInForm, [{
    ...
    value: function handleSubmit(event) {
      ...
      var url = "http://localhost:8080/checkIn?token=" + js_cookie__WEBPACK_IMPORTED_MODULE_10___default.a.get("token") + "&code=" + this.state.codeValue;
      fetch(url).then(function (res) {
        return res.json();
      }).then(function (data) {
        _this7.setState({
...
//# sourceMappingURL=index.js.c7dfc1e54ab2f28356c6.hot-update.js.map